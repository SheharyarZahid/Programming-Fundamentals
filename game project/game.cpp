...
if (bulletX >= EX && bulletX <= EX + 5 && bulletY >= EY && bulletY <= EY + 4 && e3)
            {
            bulletActive = false;
                health3--;
                score+=30;
...
void moveEnemyBullet3(int &EX, int &EY, int &pX, int &pY)
{
    ...
    if (enemi3)
    {
        ...
        {
            enemyX3--;  
            if (enemyX3 >= pX && enemyX3 <= pX + 26 && enemyY3 >= pY && enemyY3 <= pY + 7)
            {
                health-=20;
            }
        }
...
void controls(){
    ...
    cout << "#                                                                                                                                                         #" << endl;
    cout << "#                                                                                                                                                         #" << endl;
    cout << "#          ____  ____  _      _____  ____  ____  _     ____                                _____ _     _  ____  _____                                     #" << endl;
    cout << "#         /   _\\/  _ \\/ \\  /|/__ __\\/  __\\/  _ \\/ \\   / ___\\                              /  __// \\ /\\/ \\/  _ \\/  __/                                     #" << endl;
    cout << "#         |  /  | / \\|| |\\ ||  / \\  |  \\/|| / \\|| |   |    \\                              | |  _| | ||| || | \\||  \\                                       #" << endl;
    cout << "#         |  \\__| \\_/|| | \\||  | |  |    /| \\_/|| |_/\\ ___ |                              | |_//| \\_/|| || |_/||  /_                                      #" << endl;
    cout << "#          \\____/\\____/\\_/  \\|  \\_/  \\_/\\_\\____/\\____/\\____/                               \\____\\____/\\_/\\____/\\____\\                                     #" << endl;
    cout << "#                                                                                                                                                         #" << endl;
    cout << "#                                                                                                                                                         #" << endl;
    cout << "#           1) press Space to fire                                                            Kill all enemies to win                                     #" << endl;
    cout << "#                                                                                                                                                         #" << endl;
    cout << "#           2) press F to change fire direction                                               Get different scores on damaging enemies                    #" << endl;
    cout << "#                                                                                                                                                         #" << endl;
